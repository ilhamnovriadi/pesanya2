...
import {FlatList, StyleSheet, Text, View, Image, TextInput, ScrollView, TouchableOpacity, StatusBar, Button} from 'react-native';
                ...
                ({item}) =>
                  <View style={{ marginHorizontal: 16, marginBottom: 18 }}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                      <View>
                        <Text style={{fontFamily: Fonts.PoligonBold, fontSize: 18, color: 'black', paddingVertical: 3 }}>{item.title}</Text>
                        <Text style={{fontFamily: Fonts.PoligonBold, fontSize: 12, color: 'grey', paddingBottom: 8 }}>{item.genres}</Text>
                      </View>
                      <View>
                        <Text style={{fontFamily: Fonts.PoligonBold, fontSize: 14, color: 'black', top: 30, right:10}}>Rilis tahun {item.year}</Text>
                      </View>
                    </View>
                    <Image style={{ height: 200, width: '100%', borderRadius: 10 }} source={{ uri: item.posterurl }} />
                    <Image style={{ height: 30, width: 120, position: 'absolute', bottom: 16, left: 18 }} source={require('../../icon/logomini.png')} />
                    <TouchableOpacity onPress={() => navigate('Profile', {name: 'Jane'})} style={{ backgroundColor: '#3A98F3', paddingHorizontal: 15, paddingVertical: 10, position: 'absolute', borderRadius: 3, bottom: 16, right: 16 }}>
                      <Text style={{ fontSize: 11, fontWeight: 'bold', color: 'white' }}>Dapatkan Voucher!</Text>
                    </TouchableOpacity>
                  </View>
